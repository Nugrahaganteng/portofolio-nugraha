    ...
    <footer className="w-full bg-black text-white py-6 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex items-center space-x-6 mb-4 md:mb-0">
          <a 
            href="https://github.com/Nugrahaganteng" 
            target="_blank" 
          ...
          <a 
            href="https://www.instagram.com/nugrahafrzki_y/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors"
          ...
          <a 
            href="linkedin.com/in/nugraha-firizki-" 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-white transition-colors"
            aria-label="LinkedIn"
        ...
        <div className="text-gray-400 text-sm mb-4 md:mb-0">
          portofolio 2024 by <a href="#" className="text-white hover:underline">NUgraha Algeio Firizki Subarji</a>
        </div>
